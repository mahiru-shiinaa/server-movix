...
router.patch("/me", authMiddleware(UserRole.USER), userController.edit);
//[PATCH] CHANGE PASSWORD: /api/v1/users/me/change-password
router.patch("/me/change-password", authMiddleware(UserRole.USER), userController.changePassword);
